...
import StaffDetailsModal from '../details/component-staff-details-two';
...
export default function StaffTableTwo() {
    ...
    return (
        <>
            ...
            <StaffDetailsModal isOpen={isModalOpen} onClose={handleCloseModal} selectedStaff={selectedStaff} />
        </>
    );
}
