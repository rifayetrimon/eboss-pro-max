...
const AppCodePage = () => {
    ...
    return (
        <div>
            ...
            >
                <Image src={assetPath('/assets/images/auth/coming-soon-object1.png')} alt="image" className="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
                <Image src={assetPath('/assets/images/auth/coming-soon-object2.png')} alt="image" className="absolute left-24 top-0 h-40 md:left-[30%]" />
                <Image src={assetPath('/assets/images/auth/coming-soon-object3.png')} alt="image" className="absolute right-0 top-0 h-[300px]" />
                <Image src={assetPath('/assets/images/auth/polygon-object.svg')} alt="image" className="absolute bottom-0 end-[28%]" />
